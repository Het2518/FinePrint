...
import {
  ...
  BarChart3, Target, Award, AlertTriangle,
} from "lucide-react";
...
function MiniBar({ label, high, medium, low, total }: { label: string; high: number; medium: number; low: number; total: number }) {
          ...
          {outcomes?.vendor_breakdown?.length > 0 && (
            ...
            >
              ...
              <div className="space-y-0">
                ...
                {outcomes.vendor_breakdown.map((v: any, i: number) => (
                  <div
                    key={i}
